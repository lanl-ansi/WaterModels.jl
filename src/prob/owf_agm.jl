function run_owf_agm(network, model_constructor, optimizer; kwargs...)
    return run_model(network, model_constructor, optimizer, build_owf_agm; kwargs...)
end
...
function run_mn_owf_agm(file, model_constructor, optimizer; kwargs...)
    return run_model(file, model_constructor, optimizer, build_mn_owf_agm; multinetwork=true, kwargs...)
end
