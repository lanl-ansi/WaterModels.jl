function solve_wff(network, model_constructor, optimizer; kwargs...)
    return solve_model(network, model_constructor, optimizer, build_wff; kwargs...)
end


function run_wff(network, model_constructor, optimizer; kwargs...)
    Memento.warn(_LOGGER, "\"run_\" methods should be renamed \"solve_\" and will be deprecated in future versions.")
    return solve_wff(network, model_constructor, optimizer; kwargs...)
end


function solve_mn_wff(file, model_constructor, optimizer; kwargs...)
    return solve_model(file, model_constructor, optimizer, build_mn_wff; multinetwork=true, kwargs...)
end


function run_mn_wff(network, model_constructor, optimizer; kwargs...)
    Memento.warn(_LOGGER, "\"run_\" methods should be renamed \"solve_\" and will be deprecated in future versions.")
    return solve_mn_wff(network, model_constructor, optimizer; kwargs...)
end


function solve_mn_wff_switching(file, model_constructor, optimizer; kwargs...)
    return solve_model(file, model_constructor, optimizer, build_mn_wff_switching; multinetwork=true, kwargs...)
end


function run_mn_wff_switching(network, model_constructor, optimizer; kwargs...)
    Memento.warn(_LOGGER, "\"run_\" methods should be renamed \"solve_\" and will be deprecated in future versions.")
    return solve_mn_wff_switching(network, model_constructor, optimizer; kwargs...)
end


function build_wff(wm::AbstractWaterModel)
...
function build_mn_wff(wm::AbstractWaterModel)
    # Create head loss functions, if necessary.
    _function_head_loss(wm)
...
function build_mn_wff_switching(wm::AbstractWaterModel)
