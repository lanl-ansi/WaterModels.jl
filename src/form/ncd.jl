...
function _gather_directionality_data(
    wm::AbstractNCDModel,
    n::Int,
    pipe_fr::Vector{Int64},
    pipe_to::Vector{Int64},
    des_pipe_fr::Vector{Int64},
    des_pipe_to::Vector{Int64},
    pump_fr::Vector{Int64},
    pump_to::Vector{Int64},
    regulator_fr::Vector{Int64},
    regulator_to::Vector{Int64},
    short_pipe_fr::Vector{Int64},
    short_pipe_to::Vector{Int64},
    valve_fr::Vector{Int64},
    valve_to::Vector{Int64},
)
