@testset "src/util/pairwise_cuts.jl" begin
    ...
    @testset "_PairwiseProblem instantiation" begin
        ...
        problem = WaterModels._PairwiseProblem(JuMP.MOI.MIN_SENSE, vid_1, vid_2, 0.0, 1.0e-4)

        @test problem.sense === JuMP.MOI.MIN_SENSE
    ...
    @testset "_get_bound_problem_candidate! (maximization)" begin
        ...
        problem = WaterModels._PairwiseProblem(JuMP.MOI.MAX_SENSE, vid_1, vid_2, 1.0, 1.0e-4)
