@testset "Constrained Water Flow Problems" begin
    ...
    #@testset "Shamir network, CNLP formulation." begin
    #    solution = run_cwf(shamir_path, CNLPWaterModel, ipopt)
    ...
    #    data = WaterModels.parse_file(shamir_path)
    ...
    @testset "Balerma network, MILP formulation." begin
        ...
        wm = build_model(data, MILPWaterModel, WaterModels.post_cwf, ext=Dict(:num_breakpoints => 5))
